...
// !        - Give each grid slot a number and generate 10 random numbers using math.floor and math.random
...
//          - This is achived using the forEach function
//          - Checking each slot and whether the each a bomb on the surrounding grid and log the amout
...
//   Once the slot is select it will either show
//      - An empty show an empty slow which will begin a flood fill and check all the connecting empty slots
...
//      - The time take will appear underneath
